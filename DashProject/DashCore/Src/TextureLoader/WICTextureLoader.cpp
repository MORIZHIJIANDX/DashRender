...
namespace Dash
{
	...
	bool LoadWICTextureFromFile(const std::string& fileName, EWIC_LOAD_FLAGS loadFlags, FTextureBufferDescription& textureDescription, std::vector<FSubResourceData>& subResource, std::vector<uint8>& decodedData)
	{
